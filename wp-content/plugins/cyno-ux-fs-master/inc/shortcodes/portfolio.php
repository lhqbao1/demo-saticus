...
function cyno_portfolio_shortcode($atts, $content = null, $tag = '' ) {
          ...
          <div class="<?php echo implode(' ', $classes_box); ?>">
            ...
            <div class="<?php echo implode(' ', $classes_text); ?>" <?php echo get_shortcode_inline_css( $css_args ); ?>>
                  <div class="box-text-inner">
                      <?php echo '<'.$title_tag.' class="uppercase portfolio-box-title">'; ?>
                        <?php the_title(); ?>
                      <?php echo '</'.$title_tag.'>';  ?>
                      <?php if(empty($hidden_cat)) : ?>
...
add_shortcode("cyno_featured_items_slider", "cyno_portfolio_shortcode");
add_shortcode("cyno_featured_items_grid", "cyno_portfolio_shortcode");
add_shortcode("cyno_portfolio", "cyno_portfolio_shortcode");
