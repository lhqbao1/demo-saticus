...
function cyno_ux_product_categories_callback($atts, $content = null, $tag = '' ) {
  $sliderrandomid = rand();
  extract( shortcode_atts( array (
      ...
      if($tag == 'cyno_product_categories_grid'){
        $type = 'grid';
      }
    ...
    if ( $product_categories ) {
      foreach ( $product_categories as $category ) {
        ...
        if ( $thumbnail_id ) {
          ...
          $image = $image ? $image[0] : wc_placeholder_img_src('woocommerce_single');
        } else {
...
add_shortcode("cyno_product_categories", "cyno_ux_product_categories_callback");
add_shortcode("cyno_product_categories_grid", "cyno_ux_product_categories_callback");
