<?php
// [blog_posts]
function cyno_shortcode_latest_from_blog($atts, $content = null, $tag = '')
{
...
?><div class="col <?php echo implode(' ', $col_class); ?>" <?php echo $animate; ?>>
					...
					<?php if (has_post_thumbnail()) { ?>
						<div class="box-image" <?php echo get_shortcode_inline_css($css_args_img); ?>>
							<div class="<?php echo $classes_image; ?>" <?php echo get_shortcode_inline_css($css_image_height); ?>>
								<a href="<?php the_permalink() ?>" class="plain" aria-label="<?php echo esc_attr(the_title()); ?>" title="<?php echo esc_attr(the_title()); ?>">
					...
					<div class="box-text <?php echo $classes_text; ?>" <?php echo get_shortcode_inline_css($css_args); ?>>
						<div class="box-text-inner blog-post-inner">
							...
							<h5 class="post-title is-<?php echo $title_size; ?> <?php echo $title_style; ?>">
								<a href="<?php the_permalink() ?>" class="plain" title="<?php echo esc_attr(the_title()); ?>"><?php the_title(); ?></a>
							</h5>
							...
							<?php if ($readmore) { ?>
								<a href="<?php echo get_the_permalink(); ?>" class="button <?php echo $readmore_color; ?> is-<?php echo $readmore_style; ?> is-<?php echo $readmore_size; ?> mb-0" title="<?php echo esc_attr(the_title()); ?>">
									<?php echo $readmore; ?>
								</a>
							<?php } ?>
		...
		add_shortcode("cyno_blog_posts", "cyno_shortcode_latest_from_blog");
