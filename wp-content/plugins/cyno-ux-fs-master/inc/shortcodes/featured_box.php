<?php
// [featured_box]
function cyno_featured_box_callback( $atts, $content = null ) {
	...
	<?php if ( $link ) {
    echo '<a class="plain" href="' . $link . '"' . flatsome_parse_target_rel( $link_atts );

      if(!empty($alt_title)) {
        echo ' title="' . $alt_title . '"';
      }
...
add_shortcode( 'cyno_featured_box', 'cyno_featured_box_callback' );
